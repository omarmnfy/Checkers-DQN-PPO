...
class DQNAgent:
    def __init__(self, state_size=64, action_size=100, memory_size=10000):
    ...
    def act(self, state, valid_moves):
        ...
        move_to_index = {move: idx for idx, move in enumerate(valid_moves)}
    ...
    def action_to_index(self, action):
        ...
        end_row, end_col = end
        return start_row * 8 * 8 * 8 + start_col * 8 * 8 + end_row * 8 + end_col 